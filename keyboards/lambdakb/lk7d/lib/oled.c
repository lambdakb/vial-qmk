...
void render_state(void) {
    static const char PROGMEM kb_title[2][7] = {
        { 0xAB, 0xAC, 0xAD, 0xAE, 0xAF, 0x00, 0x00 },
        { 0xCB, 0xCC, 0xCD, 0xCE, 0xCF, 0x00, 0x00 }
    };
    static const char PROGMEM numlock_state[2][2][5] = {
        ...
        [1] = {
            { 0x96, 0x9A, 0x9B, 0x98, 0x00 },
            { 0x97, 0x9C, 0x9D, 0x99, 0x00 }
        },
    };
    uint16_t num_lock = 0;
    ...
    static const char PROGMEM layer_text[8][2][5] = {
        [0] = {
            { 0x96, 0xB0, 0xB1, 0x98, 0x00 },
            { 0x97, 0xD0, 0xD1, 0x99, 0x00 }
        },
        [1] = {
            { 0x96, 0xB2, 0xB3, 0x98, 0x00 },
            { 0x97, 0xD2, 0xD3, 0x99, 0x00 }
        },
        [2] = {
            { 0x96, 0xB4, 0xB5, 0x98, 0x00 },
            { 0x97, 0xD4, 0xD5, 0x99, 0x00 }
        },
        [3] = {
            { 0x96, 0xB6, 0xB7, 0x98, 0x00 },
            { 0x97, 0xD6, 0xD7, 0x99, 0x00 }
        },
        [4] = {
            { 0x96, 0xB8, 0xB9, 0x98, 0x00 },
            { 0x97, 0xD8, 0xD9, 0x99, 0x00 }
        },
        [5] = {
            { 0x96, 0xBA, 0xBB, 0x98, 0x00 },
            { 0x97, 0xDA, 0xDB, 0x99, 0x00 }
        },
        [6] = {
            { 0x96, 0xBC, 0xBD, 0x98, 0x00 },
            { 0x97, 0xDC, 0xDD, 0x99, 0x00 }
        },
        [7] = {
            { 0x96, 0xBE, 0xBF, 0x98, 0x00 },
            { 0x97, 0xDE, 0xDF, 0x99, 0x00 }
        },
